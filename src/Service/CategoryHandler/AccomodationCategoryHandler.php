...
final class AccomodationCategoryHandler implements CategoryHandlerInterface
{
    ...
    {
        return $category->getContentTypeEnum() == ContentTypeEnum::ACCOMMODATION;
    }
    ...
    {
        return 'discover/accommodation.html.twig';
    }
